...
final class SubtabsCollapseOverlay {
    private static final Key<Handle> OVERLAY_KEY = Key.create("componentSubtabs.collapseOverlay");

    private SubtabsCollapseOverlay() {
    }
